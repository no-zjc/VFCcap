...
class Vocabulary:
    ...
    def load(self, word2index_dic = 'word2index_dic.p', index2word_dic = 'index2word_dic.p', word2count_dic='word2count_dic.p'):

        w2i = os.path.join("/home/wy3/zjc_data/PyProject/zero-shot-video-to-text" + "/Metric/THVC/" + 'Saved', self.name + '_'+word2index_dic)
        i2w = os.path.join("/home/wy3/zjc_data/PyProject/zero-shot-video-to-text" + "/Metric/THVC/" + 'Saved', self.name + '_'+index2word_dic)
        w2c = os.path.join("/home/wy3/zjc_data/PyProject/zero-shot-video-to-text" + "/Metric/THVC/" + 'Saved', self.name + '_'+word2count_dic)
    ...
    def trim(self, min_count):  # Trim Rare words with frequency less than min_count
        ...
        self.word2index = {"PAD":self.cfg.PAD_token,"EOS":self.cfg.EOS_token,"SOS":self.cfg.SOS_token}
        #self.word2count = {}
        self.index2word = {self.cfg.PAD_token:"PAD",self.cfg.EOS_token:"EOS",self.cfg.SOS_token:"SOS"}
        self.num_words = 3
